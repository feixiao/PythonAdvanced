...
```
输入原文件地址:/Users/toby/Downloads/PythonAdvanced/code/2.python高级知识-多进程/案例文件夹/原文件夹
输入原文件名:原文件夹
输入存文件的地址：/Users/toby/Downloads/PythonAdvanced/code/2.python高级知识-多进程/案例文件夹/复制到的文件夹
['5.txt', '4.txt', '3.txt', '2.txt', '1.txt']
25825正在复制文件5.txt
25826正在复制文件4.txt
40.00...(5.txt)                                                  25825正在复制文件3.txt
25826正在复制文件2.txt
80.00...(2.txt)                                                  25825正在复制文件1.txt
100.00...(1.txt)
```

![图片](./img/WechatIMG51.png)
